...
контентом обернутым в \Local\Helper::ajaxBuffer()...\Local\Helper::ajaxBuffer(false) на back-end.  
...
В этом случае в \Local\Helper::ajaxBuffer()...\Local\Helper::ajaxBuffer(false) на back-end нужно оборачивать область,  
